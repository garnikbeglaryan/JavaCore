...
////        authorStorage.add(new Author("petros", "petrosyan", "petros@mail.com", 24, "male"));
//
    ...
    private static void changeBookAuthor() {
        ...
        authorStorage.changeBookAuthor(keword);
    }


    private static void changeAuthor() {
        System.out.println("please choose email");
    ...
    private static void searchBooksByAuthor() {
        System.out.println("please input by email");
        String email = scanner.nextLine();
        Book book = authorStorage.searchBooksByAuthor(email);
    ...
    private static void printCommands() {
        ...
        System.out.println("please input " + SEARCH_BOOKS_BY_AUTHOR + " for search books by autyhor");
